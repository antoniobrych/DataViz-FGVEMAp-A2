...
figure3.line(x='MesAno', y='Overall', source=cds_north_america, line_width=2, legend_label = 'América do Norte', color = '#3C2919', alpha = 1, muted_alpha = 0.2, muted_color = '#3C2919' )
figure3.line(x='MesAno', y='Overall', source=cds_south_america, line_width=2, legend_label = 'América do Sul', color = '#6A3C1A', alpha = 1, muted_alpha = 0.2, muted_color = '#6A3C1A')
figure3.line(x='MesAno', y='Overall', source=cds_central_america, line_width=2.2, legend_label = 'América Central', color = '#D99771',alpha = 1, muted_alpha = 0.2, muted_color = '#D99771')
figure3.line(x='MesAno', y='Overall', source=cds_asia, line_width=2, legend_label = 'Ásia', color = '#865D37',alpha = 1, muted_alpha = 0.2, muted_color = '#865D37')
figure3.line(x='MesAno', y='Overall', source=cds_africa, line_width=2, legend_label = 'África', color = '#B4855B',alpha = 1, muted_alpha = 0.2, muted_color = '#B4855B')
...
# Definir a nova faixa de datas desejada
new_start_date = pd.to_datetime('2022-05-01')
new_end_date = pd.to_datetime('2023-04-01')

# Definir a nova faixa do eixo x usando Range1d
